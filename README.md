...
[**materialgram**](https://github.com/kukuruzka165/materialgram) fork with Comfortaa font, deep Aether Integration and some improvements, which is based on the [Telegram API][telegram_api] and the [MTProto][telegram_proto] secure protocol.
